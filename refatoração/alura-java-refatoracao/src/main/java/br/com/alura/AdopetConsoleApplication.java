...
public class AdopetConsoleApplication {
    ...
    private static void listarAbrigo() throws Exception{
    ...
    private static void listarPetsAbrigo() throws Exception{
    ...
    private static void importarPetsAbrigo() throws Exception{
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
    ...
    private static HttpResponse<String> dispararRequisicaoPost(HttpClient client, String uri, JsonObject json) throws Exception{
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create(uri))
